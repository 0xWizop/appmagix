...
export function MobileNav() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      <div className={cn(
        "fixed top-14 left-0 bottom-0 z-50 w-64 bg-surface border-r border-border transform transition-transform duration-200 ease-in-out lg:hidden overflow-y-auto",
