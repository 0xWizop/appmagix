...
export default function WorkPage() {
  ...
  return (
    <>
      ...
      <section className="section-padding pt-24">
        <div className="container-width">
          ...
          {projects.length > 0 ? (
            ...
            <div className="text-center py-20 border border-dashed rounded-2xl bg-surface/50">
              <ExternalLink className="h-12 w-12 text-text-muted mx-auto mb-4 opacity-50" />
              <h3 className="text-xl font-medium mb-2">Our portfolio is being updated</h3>
              <p className="text-text-secondary max-w-md mx-auto">
                We are carefully documenting our latest builds and success stories. 
      ...
      {/* Stats Section - Hidden when no real stats available */}
      {projects.length > 0 && (
